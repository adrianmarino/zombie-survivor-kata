...
public class SurvivorLogger implements SurvivorEventListener {
    public static SurvivorEventListener instance = null;

    private SurvivorLogger() {
    }

    public static SurvivorEventListener getInstance() {
        return instance == null ? instance = new SurvivorLogger() : instance;
    }
